...
// Returns:   int WINAPI
// Qualifier:
// Parameter: LPCTSTR tmpStr 待注入的dll路径名
// Parameter: DWORD UnloadDLL 输入法退出时候0卸载注入的dll，1不卸载
// Parameter: DWORD loadNextIme 当本输入法激活时，是否自动打开下一个输入法 0-否，1-是
...
BOOL WINAPI ImeConfigure(HKL hKL,HWND hWnd, DWORD dwMode, LPVOID lpData)
{
    ...
    case IME_CONFIG_GENERAL:
		//Windows标准输入法扩展服务 V1.0
        MessageBox(NULL,"输入法注入","关于输入法扩展",48);
        break;
    default:
        return (FALSE);
        break;
